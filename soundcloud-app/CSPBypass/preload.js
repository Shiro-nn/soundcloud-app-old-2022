...
electron.ipcRenderer.on('load-url', function (event, url) {
    var webview = domify('<webview src="' + url + '" preload="./webview.js" nodeintegration webpreferences="nativeWindowOpen=true" allowpopups partition="persist:webviewsession"></webview>');
